    ...
    <>
      <div className=" details">
        <div className=" detailsBox">
          <h2>Conditions</h2>
          <p>
            The [URL] Web Site (the "Site") is an online information service
            provided by [Company Name] ("[URL]"), subject to your compliance
            ...
            conditions, you may not access or use the site. [url] may modify
          ...
          <p>
            ...
            trademarks are [URL], its affiliates or other third party licensors.
          ...
          <p>
            You agree to grant to [URL] a non-exclusive, royalty-free,
            ...
            or by e-mail to [URL] by all means and in any media now known or
            hereafter developed. You also grant to [URL] the right to use your
            ...
            have no recourse against [URL] for any alleged or actual
            infringement or misappropriation of any proprietary right in your
            communications to [URL]. TRADEMARKS Publications, products, content
            or services referenced herein or on the Site are the exclusive
            trademarks or servicemarks of [URL]. Other product and company names
          ...
          <p>
            ...
            the Internet in any way. Except for [URL]- identified information,
            ...
            parties, that are not affiliated with [URL] a. You also understand
            that [URL] cannot and does not guarantee or warrant that files
          ...
          <p>
            ...
            provided through the service or on the internet generally, and [url]
            shall not be liable for any cost or damage arising either directly
            ...
            provided through the service or on the internet generally. [url]
          ...
          <p>
            ...
            [url] has no control over and accepts no responsibility whatsoever
            for such materials.
          </p>
          ...
          <p>
            ...
            information or service. Even if [url] or its authorized
          ...
          <p>
            ...
            Site. When you access a non- [URL] web site, please understand that
            it is independent from [URL], and that [URL] has no control over the
            content on that web site. In addition, a link to a [URL] web site
            does not mean that [URL] endorses or accepts any responsibility for
          ...
          <p>
            ...
            with the laws of the Land applicable to agreements made and to be
            performed in the Land. You agree that any legal action or proceeding
            ...
            federal or state court of competent jurisdiction sitting in USA.
          </p>
          ...
          <p>
            ...
            [URL] 's failure to insist upon or enforce strict performance of any
            ...
            Agreement. [URL] may assign its rights and duties under this
